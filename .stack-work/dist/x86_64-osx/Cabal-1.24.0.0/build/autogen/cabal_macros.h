...
/* package transducers-0.1.0.0 */
#define VERSION_transducers "0.1.0.0"
#define MIN_VERSION_transducers(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "transducers-0.1.0.0-Alm2F19OaEg3quahTdCHoB"

#define CURRENT_PACKAGE_KEY "transducers-0.1.0.0-Alm2F19OaEg3quahTdCHoB"
